...
namespace ApplicationCore.Specifications.DietPlanPeriodSpecs
{
    ...
    {
        public DietPlanPeriodFilterPaginatedSpecification(int skip, int take, DateTime? startDateGTE, DateTime? startDateLTE, DateTime? endDateGTE, DateTime? endDateLTE)
        {
