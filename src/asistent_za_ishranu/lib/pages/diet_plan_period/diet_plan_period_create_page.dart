...
class DietPlanPeriodCreatePage extends StatefulWidget {
  const DietPlanPeriodCreatePage({Key? key}) : super(key: key);

  static const routeName = "/diet_plan_period_create";

  @override
  _DietPlanPeriodCreatePageState createState() =>
      _DietPlanPeriodCreatePageState();
}

class _DietPlanPeriodCreatePageState extends State<DietPlanPeriodCreatePage> {
  ...
  Future<void> create() async {
    {
      ...
      await apiService.post("api/dietplanperiod",
          DietPlanPeriodRequest(dietPlanId, startDate, endDate, 0, AuthService().userId).modelToJson());
